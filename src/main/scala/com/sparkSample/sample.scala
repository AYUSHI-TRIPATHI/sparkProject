...
object sample {
  ...
  // 31. Not In the bus
  def incident_notinbus(Df31:DataFrame): Dataset[Row] = {
  ...
  //32. In the bus
  def incident_inbus(Df32:DataFrame): Dataset[Row] = {
  ...
  //4.less accident
  def less_accidents(Df4:DataFrame): DataFrame = {
